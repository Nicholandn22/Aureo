    ...
    <div className="mobile-container bg-background min-h-screen">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-2">
            <Image
              ...
              width={32}
              height={32}
              className="w-8 h-8 rounded-xl shadow-lg shadow-amber-500/20"
            />
      ...
      <section className="pt-20 px-4 pb-8">
        ...
        <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
          The intelligent fintech wallet that combines gold stability with
          ...
          {[
            {
              step: 1,
              title: "Deposit USDC",
              desc: "Add funds to your AUREO wallet",
            },
            {
              step: 2,
              title: "AI Buys Gold",
              desc: "Our AI finds the best entry point",
            },
            {
              step: 3,
              title: "Pay Anywhere",
              desc: "Spend instantly via QR or transfer",
            },
          ].map((item) => (
